...
export default function GpsTracking() {
  ...
  useEffect(() => {
    const fetchDeliveries = async () => {
      try {
        const res = await axiosInstance.get(`${BACKEND_URL}/deliveries`);
      ...
      {deliveries.length > 0 ? (
        <>
          <div style={{ marginBottom: "20px" }}>
            <label htmlFor="delivery-select" style={{ fontWeight: "bold" }}>
          ...
          {selectedDelivery ? (
            <>
              ...
              >
                    ...
                    style={{
                      ...
                      backgroundColor:
                        selectedDelivery.status === "Completed"
                          ? "#c6f6d5"
                          : selectedDelivery.status === "Ongoing"
                          ? "#fed7d7"
                          : "#e9ecef",
                      color:
                        selectedDelivery.status === "Completed"
                ...
                {selectedDelivery.driver && (
                  <p>
                    ...
                    {typeof selectedDelivery.driver === "object"
                ...
                {selectedDelivery.vehicle && (
                  <p>
                    ...
                    {typeof selectedDelivery.vehicle === "object"
                      ? selectedDelivery.vehicle.vehicleNumber
                      : "Assigned"}
                  </p>
                )}
              </div>
              ...
              >
                ...
                >
                  <p>
                    Latitude: {vehicleLocation.lat.toFixed(6)}, Longitude:{" "}
                    {vehicleLocation.lng.toFixed(6)}
                  </p>
                  <p>
                    <em>
                      Note: This is simulated tracking data. In a real
                      application, this would come from GPS devices.
                    </em>
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <p>
                <em>Only ongoing deliveries are shown in the dropdown</em>
              </p>
            </div>
          )}
        </>
